        ...
        implements ContextualSerializer
{
    ...
    public static com.fasterxml.jackson.databind.ser.std.EnumSerializer construct(Class<?> enumClass, SerializationConfig config,
                                                                                  BeanDescription beanDesc, JsonFormat.Value format)
    {
        ...
        return new com.fasterxml.jackson.databind.ser.std.EnumSerializer(v, serializeAsIndex);
    }
                                              ...
                                              BeanProperty property) throws JsonMappingException
    {
        ...
        if (format != null) {
            ...
            if (serializeAsIndex != _serializeAsIndex) {
                return new com.fasterxml.jackson.databind.ser.std.EnumSerializer(_values, serializeAsIndex);
            }
        }
        return this;
    }
