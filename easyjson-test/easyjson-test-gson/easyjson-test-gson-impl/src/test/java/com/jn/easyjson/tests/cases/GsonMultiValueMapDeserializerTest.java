...
public class GsonMultiValueMapDeserializerTest {
    ...
    public void test(){
        ...
        MultiValueMap<String, Integer> result = json.fromJson(jsonstring, new TypeToken<MultiValueMap<String, Integer>>(){}.getType());
