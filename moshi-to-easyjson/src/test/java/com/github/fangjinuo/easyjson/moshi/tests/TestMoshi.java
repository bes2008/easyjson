...
public class TestMoshi extends BaseTests {
    ...
    public void test() throws Exception {
        ...
        // test simple object
        String str1 = personJsonAdapter.toJson(BaseTests.person);
        System.out.println(str1);
        Person p1 = personJsonAdapter.fromJson(str1);
        System.out.println(p1.equals(BaseTests.person));
        ...
        // test list
        String str2 = listJsonAdapter.toJson(BaseTests.persons);
        ...
        // test map
        String str3 = mapJsonAdapter.toJson(BaseTests.idToPersonMap);
